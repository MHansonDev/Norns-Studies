  ...
  // see its implementation for details.
	*new { arg context, doneCallback;
	...
	alloc {
		...
		SynthDef(\twoButton, { | inL, inR, out, amp=0.5, ampHz=4, fund=40, maxPartial=4, width=0.5, release=1.65 |
      ...
      // sig2 = Pulse.ar(freq2, width, amp2);
			...
			Out.ar(0, MoogFF.ar(sig1, 1600, 2) * env);
		...
		this.addCommand(\hz, "fff", { arg msg;
		  ...
		  Synth.new(\twoButton, [\inL, context.in_b[0].index, \inR, context.in_b[1].index, \out, context.out_b.index,
